      ...
      <section class="resume-section p-3 p-lg-5 d-flex d-column" id="about">
          <div class="my-auto" >
            <h2 class="mb-0">ABOUT ME</h2>
              <h1 class="mb-0">
                <span class="text-primary">NANDITA AFRILIA S</span>
              </h1>
              <p class="mb-5" style="max-width: 500px;" >I am an Informatics Engineering student from Muhammadiyah University, Sukabumi. I am a person who loves programming languages and interested in a career in software or application development.</p>
            <h2 class="mb-0">EDUCATION</h2>
            <p class="mb-4" style="max-width: 500px;" >SMA Negeri 1 Sukabumi 2017-2020</br>Universitas Muhammadiyah Sukabumi 2020-2024</p>
          </div>
      </section>
              ...
              <div class="resume-item col-md-12 col-sm-12 " > 
                <div class="card mx-0 p-4 mb-5" style="border-color: #17a2b8; box-shadow: 2px 2px 2px rgba(0, 0, 0, 0.21);">
                  <div class=" resume-content mr-auto">
                      <h4 class="mb-2"><i class="fa fa-laptop mr-3 text-warning"></i>Create and Test Application for Websites</h4>
                  </div>
                </div>  
              </div>
              <div class="resume-item col-md-12 col-sm-12 " > 
                <div class="card mx-0 p-4 mb-5" style="border-color: #17a2b8; box-shadow: 2px 2px 2px rgba(0, 0, 0, 0.21);">
                  <div class=" resume-content mr-auto">
                      <h4 class="mb-2"><i class="fa fa-laptop mr-3 text-warning"></i>Develop Web Application</h4>
                  </div>
                </div>  
              </div>
              <div class="resume-item col-md-12 col-sm-12 " > 
                <div class="card mx-0 p-4 mb-5" style="border-color: #17a2b8; box-shadow: 2px 2px 2px rgba(0, 0, 0, 0.21);">
                  <div class=" resume-content mr-auto">
                      <h4 class="mb-2"><i class="fa fa-laptop mr-3 text-warning"></i>Monitor Website Traffic</h4>
                  </div>
                </div>  
              </div>
              <div class="resume-item col-md-12 col-sm-12 " > 
                <div class="card mx-0 p-4 mb-5" style="border-color: #17a2b8; box-shadow: 2px 2px 2px rgba(0, 0, 0, 0.21);">
                  <div class=" resume-content mr-auto">
                      <h4 class="mb-2"><i class="fa fa-laptop mr-3 text-warning"></i>Maintain and Update Website</h4>
                  </div>
                </div>  
              </div>
          </div>
          ...
          <div class="row text-center my-auto "> 
              <div class="col-md-3 col-sm-6">
                  <div class="skill-item">
                      ...
                      <h2><span class="counter"> 90 </span><span>%</span></h2>
                      <p>HTML5</p>
                  </div>
              </div>
              <div class="col-md-3 col-sm-6">
            ...
            <div class="col-md-4 col-sm-12 mt-5"> 
              <div class="contact-cont2"> 
                <div class="contact-add contact-box-desc">
                  ...
                  <p>Jl. Merbabu, Perum Gading Kencana Asri<br>
                  Blok G4 No. 12, Sukabumi, Jawa Barat <br></p>
                </div>
                ...
                <address class="address-details-f">nandita20afrilia@gmail.com</a>
                </address>
                <ul class="list-inline social-icon-f top-data">
                  <li><a href="http://www.facebook.com" target="_empty"><i class="fa top-social fa-facebook" style="color: #4267b2; border-color:#4267b2;"></i></a></li>
                  <li><a href="http://twitter.com" target="_empty"><i class="fa top-social fa-twitter" style="color: #4AB3F4; border-color:#4AB3F4;"></i></a></li>
                  <li><a href="http://www.instagram.com" target="_empty"><i class="fa top-social fa-instagram" style="color: #e24343; border-color:#e24343;"></i></a></li> 
                </ul>
                </div>
              </div>
            </div> 
      ...
      <section class=" d-flex flex-column" id="maps">
        <div id="map">
          <div class="map-responsive">
             <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d3960.8690734899283!2d106.9135386361218!3d-6.906255645878523!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e0!3m2!1sid!2sid!4v1684048923475!5m2!1sid!2sid" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>>
          </div>
        </div>
      </section>
